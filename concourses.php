...
<section style="margin-top:90px;">
   ...
   <div class="container-fluid">
      ...
      <?php if ($utype === 'Owner'): ?>
         ...
         <button id="openAddConcourseModal" class="btn-sm btn btn-success"
            style="display: block; margin: 0 auto; margin-bottom: 10px;">Add Concourse</button>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="d-flex flex-row-reverse">
                     <button onclick="SearchConcourse()" style="width:5rem;  margin: 10px 30px 10px 0; border-radius: 0px 5px 5px 0px;" class="form-control btn btn-primary">Search</button>
                     <input type="text" id="searchspace" placeholder="Search Space.." class="form-control"
                        style="width:15rem;  margin: 10px 0px 10px 30px; border-radius: 5px 0px 0px 5px" />
                  </div>
               </div>
               <!-- <div class="col-xl-12">
                  <div class="d-flex flex-row-reverse">
                     <div class="card" style=" width: 20rem; margin: 0px 30px 30px 0px; padding:10px;">
                        TEST
                     </div>
                  </div>
               </div> -->
...
<script>
   ...
   // $('#searchspace').on('input')
   function SearchConcourse(){
      var searchVal = $("#searchspace").val();
      loadConcourses(1, searchVal);
      
   }

   function loadConcourses(page, searchVal) {

      $.ajax({
         type: 'GET',
         url: 'get_concourse.php',
         data: { page: page, searchvalue: searchVal},
