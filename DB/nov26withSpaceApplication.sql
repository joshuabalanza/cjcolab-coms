...
INSERT INTO `space` (`space_id`, `concourse_id`, `space_name`, `status`, `space_width`, `space_length`, `space_height`, `space_status`, `space_tenant`, `space_bill`) VALUES
(1, 17, 'space 1', 'reserved', 12, 12, 12, 'available', NULL, NULL),
(2, 17, 'Space 2', 'available', 10, 15, 20, 'available', NULL, NULL);
...
(2, 'space 1', 'Coms Tenant', 'comstenant@gmail.com', 'pending');
...
--
ALTER TABLE `concourse_verification`
  MODIFY `concourse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
