...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2023 at 03:10 PM
...
INSERT INTO `bill` (`bill_id`, `space_id`, `tenant_name`, `electric`, `water`, `space_bill`, `total`, `due_date`, `created_at`) VALUES
(1, 1, 'Coms Tenant', '1200.00', '300.00', '1700.00', '3200.00', '2023-12-03', '2023-11-26 11:48:10'),
(2, 1, 'Coms Tenant', '1500.00', '500.00', '1700.00', '3700.00', '2023-12-03', '2023-11-26 11:52:30'),
(3, 1, 'Coms Tenant', '1250.00', '250.00', '1700.00', '3200.00', '2023-12-03', '2023-11-26 11:59:03'),
(4, 1, 'Coms Tenant', '1500.00', '250.00', '1700.00', '3450.00', '2023-12-03', '2023-11-26 12:01:15');
...
(226, 1, '', 'Your Concourse application has been approved.', 'unread', 'MAP APPLICATION', '2023-11-26 08:47:48', 1, '');
...
INSERT INTO `space` (`space_id`, `concourse_id`, `space_name`, `status`, `space_width`, `space_length`, `space_height`, `coordinates`, `space_tenant`, `space_bill`) VALUES
(1, 17, 'space 1', 'occupied', 12, 12, 12, 0, 'Coms Tenant', 1700),
(2, 17, 'Space 2', 'available', 10, 15, 20, 0, NULL, NULL),
(3, 17, 'Space 3', 'available', 15, 15, 15, 0, NULL, NULL),
(4, 17, 'Space 4', 'available', 5, 5, 5, 0, NULL, NULL),
(5, 17, 'Space 5', 'available', 45, 45, 45, 0, NULL, NULL),
(6, 17, 'Space 5', 'available', 4, 4, 4, 0, NULL, NULL);
...
INSERT INTO `space_application` (`app_id`, `spacename`, `tenant_name`, `ap_email`, `status`) VALUES
(1, 'space 1', 'Coms Tenant', 'comstenant@gmail.com', 'rejected'),
(2, 'space 1', 'Coms Tenant', 'comstenant@gmail.com', 'approved');
...
(1, 'Coms Owner', 'comsowner@gmail.com', 'owner', '$2y$10$d1u2.EbIT48MYVfqHylzsOTBvUneJSSLUrIvEkf47TiFO1AN2GRfm', 0, 'Owner', '', '2023-11-24 16:44:55', '', '', NULL, NULL, '', '57981', NULL, 'inh7m7g9adc02jfk56leob', '', 1),
(2, 'Coms Tenant', 'comstenant@gmail.com', 'tenant2', '$2y$10$Ba/h7WjCOZCFSrIKIIMcSuoiozGFJyTxZUVrKZp0pm3J0Euj8Q1NK', 0, 'Tenant', '', '2023-11-25 14:42:28', '', '', NULL, NULL, '', '86935', NULL, '2dm9f9hag9k9biclo8jen2', '', 1),
